...
<link rel="stylesheet" type="text/css"
	href="resources/css/member/memberDetailView.css">
</head>
<body>
		...
		<div class="viewArea">
			<form action="<%= contextPath %>/update.me" method="post"
				...
				<table id="infoTable" border="1" align="center">
					...
					<tr>
						<th>* 이름</th>
						<td><input type="text" name="memName" maxlength="5" required
							value="<%= memName %>"></td>
					</tr>
					<tr>
						<th>비밀번호</th>
						<td>
							<div class="btn1" id="pwdBtn">
								<a href="" data-toggle="modal" data-target="#resetPwd">비밀번호
									초기화</a>
							</div>
						</td>
					</tr>
					...
					<tr>
						<th>이메일</th>
						<td><input type="text" name="emailId" value="<%= emailId %>">@<input type="text" name="domain" value="<%= domain %>">
					...
					<tr>
						...
						<td><select name="byear" id="byear">
								...
								<% } %>
								<% } %>
						</select> 년 <select name="bmonth" id="bmonth">
								<option>--</option>
								<%for(int i=1; i<=12; i++){ %>
								...
								<% } %>
						</select> 월 <select name="bday" id="bday">
								<option>--</option>
								<%for(int i=1; i<=31; i++){ %>
							...
							<button type="button" onclick="memBirthReset();"
								class="btn btn-secondary">reset</button> <script>
			...
			<div class="bottomArea">
				...
				<div class="btn1" id="dmBtn">
					<a href="" id="btn1" data-toggle="modal"
						data-target="#deleteMember">회원탈퇴</a>
				</div>
				...
				<div class="btn2" id="udBtn">
					<a href="" id="btn3" onclick="return checkRequered();"
						data-toggle="modal" data-target="#updateMember">회원정보 수정</a>
				</div>
	...
	<div class="modal fade" id="resetPwd" align="center">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content" id="resetPwdModalContent">
				...
				<!-- Modal body -->
				<br>
				<div class="modal-body">비밀번호를 초기화하시겠습니까?</div>

				<form action="<%= contextPath %>/resetPwd.me" method="post">
					<div class="input-group mb-3" id="resetPwdModalContent2">
						<div class="input-group-prepend">
							<span class="input-group-text" id="basic-addon1"><i
								class="bi bi-key" style="padding-left: 3px;"></i></span>
						</div>
						<input name="adminPwd" size="25" type="password"
							placeholder=" 관리자 비밀번호" aria-label="관리자 비밀번호"
							aria-describedby="basic-addon1"> <input name="memNo"
							type="hidden" value="<%=memNo%>">

					</div>

					<!-- Modal footer -->
					<div id="modalFooter">
						<button type="submit" id="okBtn" class="btn btn-warning"
							onclick="return resetPwd();">OK</button>
						<button type="button" id="cancleBtn" data-dismiss="modal"
	...
	<div class="modal fade" id="deleteMember" align="center">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content" id="deleteMemberModalContent">
				...
				<!-- Modal body -->
				<br>
				<div class="modal-body">회원탈퇴 처리하시겠습니까?</div>
				...
				<form action="<%= contextPath %>/delete.me" method="post">
					<div class="input-group mb-3" id="deleteMemberModalContent2">
						...
						<input name="adminPwd3" size="25" type="password"
							placeholder=" 관리자 비밀번호" aria-label="관리자 비밀번호"
							aria-describedby="basic-addon1"> <input name="memNo"
							type="hidden" value="<%=memNo%>">
					</div>
					...
					<div id="modalFooter">
						<button type="submit" id="okBtn" class="btn btn-warning"
							onclick="return deleteMember();">OK</button>
	...
	<div class="modal fade" id="updateMember" align="center">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content" id="updateMemberModalContent">
				...
				<!-- Modal body -->
				<br>
				<div class="modal-body">회원정보를 수정하시겠습니까?</div>
				...
				<div class="input-group mb-3" id="updateMemberModalContent2">
					...
					<input name="adminPwd2" size="25" type="password"
						placeholder=" 관리자 비밀번호" aria-label="관리자 비밀번호"
				...
				<!-- Modal footer -->
				<div id="modalFooter">
					<button id="okBtn" class="btn btn-warning"
						onclick="return updateMember();">OK</button>
					<button id="cancleBtn" data-dismiss="modal"
						class="btn btn-secondary">Cancle</button>
				</div>
				<script>
